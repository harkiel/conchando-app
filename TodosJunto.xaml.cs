...
{ 
    public partial class TodosJunto : ContentPage
    {
       
        //metro
        public Polyline  metroRuta2 = new Polyline();
        public Polyline metroRuta1 = new Polyline();


        //omsa
        public Polyline omsa27America = new Polyline();
        public Polyline omsaHipVillamella = new Polyline();

        // guaua
        public Polyline guagua_kennedy23 = new Polyline();
        public Polyline guagua_kennedy27 = new Polyline();
        public Polyline guagua_haina_paruqe_ind = new Polyline();


        // voladora

        public Polyline mini_Pind_pulga = new Polyline();
        public Polyline mini_pulga_9 = new Polyline();
        // caro
        public Polyline kennedy = new Polyline();
        public Polyline luperon_parque_ind = new Polyline();
        //==========================================================
        ...
        public TodosJunto()
        {
            ...
            kennedy.Clicked += Polyline_Clicked;
            //=================================
            ...
            guagua_haina_paruqe_ind.Tag = "Guagua Haina - Parque Ind \n Precio Min: 30 \n Precio Max: 35";
            ...
            mini_pulga_9.Tag = "Minibus Pulga - KM 9 \n Precio Min: 30 \n Precio Max: 35";
            ...
            omsa27America.Tag = "Omsa Av. 27 - America \n Precio Min: 30 \n Precio Max: 35";
            ...
            omsaHipVillamella.Tag = "Omsa Hipodromo - Villa Mella \n Precio Min: 30 \n Precio Max: 35";
        ...
        void Polyline_Clicked(object sender, EventArgs e)
        {
            ...
            DisplayAlert("Detalles", $"{(string)polyline.Tag} ", "Cerrar");
        }

        async void OnCarritoClicked(Object sender, EventArgs e)
        {
            hideMetro();
            hideOmsa();
            showCarro();
        ...
        //==========================================
        async void OnVoladoraClicked(Object sender, EventArgs e)
        {
            hideMetro();
            hideOmsa();
            hideCarro();
        ...
        //==========================================
        async void OnGuaguaClicked(Object sender, EventArgs e)
        {
            hideMetro();
            hideOmsa();
            hideCarro();
        ...
        //==========================================
        async  void OnOmsaClicked(Object sender, EventArgs e)
        {
            hideMetro();
            ShowOmsa();
            hideCarro();
        ...
        //==========================================
        async void OnMetroClicked(Object sender, EventArgs e)
        {
            showMetro();
            hideOmsa();
            hideCarro();
        ...
        {
            map.Polylines.Remove(metroRuta1);
            map.Polylines.Remove(metroRuta2);
        ...
        public void hideOmsa()
        {
            map.Polylines.Remove(omsa27America);
            map.Polylines.Remove(omsaHipVillamella);
        }
        public void ShowOmsa()
        {
            map.Polylines.Add(omsa27America);
            map.Polylines.Add(omsaHipVillamella);
        }
        //=================
        public void hideCarro()
        {
            map.Polylines.Remove(kennedy);
            map.Polylines.Remove(luperon_parque_ind);
        ...
        public void hideVoladora()
        {
            map.Polylines.Remove(mini_pulga_9);
            map.Polylines.Remove(mini_Pind_pulga);
        }
        public void showVoladora()
        {
            map.Polylines.Add(mini_pulga_9);
            map.Polylines.Add(mini_Pind_pulga);
        }
        //======================
        public void hideGuagua()
        {
            map.Polylines.Remove(guagua_kennedy23);
            map.Polylines.Remove(guagua_kennedy27);
            map.Polylines.Remove(guagua_haina_paruqe_ind);
        }
        public void showGuagua()
        {
